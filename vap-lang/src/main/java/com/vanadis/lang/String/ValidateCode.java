...
public class ValidateCode {
    ...
    public static void main(String[] args) {
        ...
        try {
            String path = System.getProperty("user.dir") + "/" + new Date().getTime() + ".png";
     ...
     */
   /* @ApiOperation("获取验证码")
    @RequestMapping(value = "img-code",method = RequestMethod.GET)
    public void imgCode(HttpServletRequest request,
        ...
        session.setAttribute("img-code", vCode.getCode());
